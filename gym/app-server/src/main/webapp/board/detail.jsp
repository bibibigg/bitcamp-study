...
%>
      <a href='https://kr.object.ncloudstorage.com/bitcamp-nc7-bucket-13/board/${file.filePath}'>${file.filePath}</a>
      [<a href='/board/delete.jsp?category=${param.category}&no=${file.no}'>삭제</a>]<br>
<%
      }
%>
      ...
      <a href='/board/delete.jsp?category=${param.category}&no=${param.no}' onclick='return confirm("정말로 삭제하시겠습니까?")'>삭제</a>

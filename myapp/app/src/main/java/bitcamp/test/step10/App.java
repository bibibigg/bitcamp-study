...
public class App {
  ...
  static class Score {
    ...
    // 팩토리 메서드
    static Score creat(String name, int kor, int eng, int math) {
      Score s = new Score();
      s.name = name;
      s.kor = kor;
      s.eng = eng;
  ...
  public static void main(String[] args) {
    ...
    scores[length++] = Score.creat("홍길동", 100, 100, 100);
    scores[length++] = Score.creat("임꺽정", 90, 90, 90);
    scores[length++] = Score.creat("유관순", 80, 80, 80);

...
%>
<tr><td><%=m.getNo()%></td><td>
<img src='http://eptvhysxbghp19010745.cdn.ntruss.com/member/<%=m.getPhoto()%>?type=f&w=30&h=40&faceopt=true&ttype=jpg'>
<a href='/member/detail.jsp?no=<%=m.getNo()%>'><%=m.getName()%></a></td><td><%=m.getEmail()%></td></tr>

<%@ page
    ...
    trimDirectiveWhitespaces="true"%> <%-- directive element --%>
...
%>
        <a href='https://kr.object.ncloudstorage.com/bitcamp-nc7-bucket-13/board/<%=file.getFilePath()%>'><%=file.getFilePath()%></a>

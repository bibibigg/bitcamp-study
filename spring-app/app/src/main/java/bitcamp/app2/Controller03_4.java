...
public class Controller03_4 {
  ...
  public String step0(HttpSession session) {
   //프론트 컨트롤러에게 HttpSession을 요구하면
    ...
    // 보통 로그인 과정에서 HttpSesion 객채가 준비될 것이고,
    ...
    // 예제를 실행하는 과정에서 HttpSession 객체를 미리 준비한 필요가 있기 때문에
